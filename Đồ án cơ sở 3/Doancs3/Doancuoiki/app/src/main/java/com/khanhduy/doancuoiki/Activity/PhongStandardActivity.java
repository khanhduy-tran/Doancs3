...
import com.khanhduy.doancuoiki.Adapter.StandardAdapter;
...
public class PhongStandardActivity extends AppCompatActivity {
    Toolbar toolBarStandard;
    ListView listViewStandard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phong_standard);
        AnhXa();
        GetIdLoaiPhong();
        ActionToolBar();
    ...
    private void Loadmoredata() {
        ...
        listViewStandard.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pagePhong, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response != null && response.length() != 2){
                    listViewStandard.removeFooterView(footerView);
                    try {
    ...
    private void ActionToolBar() {
        setSupportActionBar(toolBarStandard);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolBarStandard.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void AnhXa() {
        toolBarStandard = (Toolbar) findViewById(R.id.toolBarStandard);
        listViewStandard = (ListView) findViewById(R.id.listViewStandard);

        phongArrayList = new ArrayList<>();
        standardAdapter = new StandardAdapter(getApplicationContext(),phongArrayList);

        listViewStandard.setAdapter(standardAdapter);
    ...
    public class mHandler extends Handler{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    listViewStandard.addFooterView(footerView);
                    break;
                case 1:
                    GetData(++page);
                    isLoading = false;
