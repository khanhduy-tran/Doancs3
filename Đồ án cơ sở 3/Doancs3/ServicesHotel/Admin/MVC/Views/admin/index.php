...
<head>
  ...
  <title>Quản Trị Booking Hotel</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Trang Quản Trị</h1>
                ...
                if (isset($_SESSION['isLogin_Admin']) && $_SESSION['isLogin_Admin'] == true) {
                  ...
                  switch ($mod) {
                    ...
                    case 'sanpham':
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/phong/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/phong/add.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/phong/edit.php');
                          break;
                         case 'detail':
                         require_once('MVC/views/phong/detail.php');
                         break; 
                        default:
                          require_once('MVC/views/phong/list.php');
                          break;
                      ...
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/dichvu/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/dichvu/add.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/dichvu/edit.php');
                          break;
                         case 'detail':
                         require_once('MVC/views/dichvu/detail.php');
                         break; 
                        default:
                          require_once('MVC/views/dichvu/list.php');
                          break;
                    ...
                    case 'hoadon':
                      ...
                      switch ($act) {
                        case 'list':
                          require_once('MVC/Views/hoadonmonan/list.php');
                          break;
                        case 'chitiet':
                          require_once('MVC/Views/hoadonmonan/detail.php');
                          break;
                        default:
                          require_once('MVC/Views/hoadonmonan/list.php');
                          break;
